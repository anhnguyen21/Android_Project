...
public class RelatedAdapter extends RecyclerView.Adapter<RelatedAdapter.PopularViewHolder> {

    private Context context;
    private List<Popular> popularList;

    public RelatedAdapter(Context context, List<Popular> popularList) {
